...
class Ak < Formula
  ...
  bottle do
    sha256 cellar: :any, arm64_sonoma:   "{{BOTTLE_ARM64_SONOMA_SHA256}}"
    sha256 cellar: :any, arm64_ventura:  "{{BOTTLE_ARM64_VENTURA_SHA256}}"
    sha256 cellar: :any, arm64_monterey: "{{BOTTLE_ARM64_MONTEREY_SHA256}}"
    sha256 cellar: :any, sonoma:         "{{BOTTLE_SONOMA_SHA256}}"
    sha256 cellar: :any, ventura:        "{{BOTTLE_VENTURA_SHA256}}"
    sha256 cellar: :any, monterey:       "{{BOTTLE_MONTEREY_SHA256}}"
  end
  ...
  def install
    ...
    # Set up shell integration for environment loading
  ...
  def setup_shell_integration
    ...
    puts "Run 'ak install-shell' manually after installation to enable shell integration"
  end
