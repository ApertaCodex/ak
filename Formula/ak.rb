...
class Ak < Formula
  ...
  url "https://github.com/apertacodex/ak/archive/v4.10.6.tar.gz"
  version "4.10.6"
  ...
  def caveats
    <<~EOS
      ...
      Setup (Required):
        ak install-shell   # Set up shell integration (enables ak_load functions)
        ak config init     # Initialize configuration

      Usage:
        ak --help          # Show all commands and options
        ak load default    # Load default profile into current shell (after install-shell)
