...
const std::map<std::string, BuiltinService> BUILTIN_SERVICES = {
    ...
    {"brave", {"brave", "BRAVE_API_KEY", "Brave Search API", "", "Bearer", true}},
    {"cohere", {"cohere", "COHERE_API_KEY", "Cohere AI", "", "Bearer", true}},
    {"deepseek", {"deepseek", "DEEPSEEK_API_KEY", "DeepSeek AI", "", "Bearer", true}},
    {"exa", {"exa", "EXA_API_KEY", "Exa Search", "", "Bearer", true}},
    {"fireworks", {"fireworks", "FIREWORKS_API_KEY", "Fireworks AI", "", "Bearer", true}},
    {"gemini", {"gemini", "GEMINI_API_KEY", "Google Gemini", "", "Bearer", true}},
    {"groq", {"groq", "GROQ_API_KEY", "Groq AI", "", "Bearer", true}},
    {"huggingface", {"huggingface", "HUGGINGFACE_TOKEN", "Hugging Face", "", "Bearer", true}},
    {"mistral", {"mistral", "MISTRAL_API_KEY", "Mistral AI", "", "Bearer", true}},
    {"openai", {"openai", "OPENAI_API_KEY", "OpenAI", "https://api.openai.com/v1/models", "Bearer", true}},
    {"openrouter", {"openrouter", "OPENROUTER_API_KEY", "OpenRouter", "", "Bearer", true}},
    {"perplexity", {"perplexity", "PERPLEXITY_API_KEY", "Perplexity AI", "", "Bearer", true}},
    {"sambanova", {"sambanova", "SAMBANOVA_API_KEY", "SambaNova AI", "", "Bearer", true}},
    {"tavily", {"tavily", "TAVILY_API_KEY", "Tavily Search", "", "Bearer", true}},
    {"together", {"together", "TOGETHER_API_KEY", "Together AI", "", "Bearer", true}},
    {"xai", {"xai", "XAI_API_KEY", "xAI Grok", "", "Bearer", true}},
    // Cloud providers
    ...
    {"github", {"github", "GITHUB_TOKEN", "GitHub", "", "Bearer", false}},
    ...
    {"stripe", {"stripe", "STRIPE_SECRET_KEY", "Stripe Payment", "", "Bearer", false}},
    {"sendgrid", {"sendgrid", "SENDGRID_API_KEY", "SendGrid Email", "", "Bearer", false}},
    {"twilio", {"twilio", "TWILIO_AUTH_TOKEN", "Twilio", "", "Basic Auth", false}},
    {"slack", {"slack", "SLACK_API_TOKEN", "Slack", "", "Bearer", false}},
    {"discord", {"discord", "DISCORD_TOKEN", "Discord Bot", "", "Bot", false}},
    {"vercel", {"vercel", "VERCEL_TOKEN", "Vercel", "", "Bearer", false}},
    {"netlify", {"netlify", "NETLIFY_AUTH_TOKEN", "Netlify", "", "Bearer", false}},
};
