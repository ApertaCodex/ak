...
static void showLogo() {
    ...
    // Gradient effect: BRIGHT_MAGENTA -> BRIGHT_BLUE -> BRIGHT_CYAN -> BRIGHT_GREEN -> BRIGHT_YELLOW -> BRIGHT_WHITE
    cout << colorize("        ████████╗   ██╗  ██╗", Colors::BRIGHT_MAGENTA) << "\n";
    cout << colorize("        ██╔══╗██║   ██║ ██╔╝", Colors::BRIGHT_BLUE) << "\n";
    cout << colorize("        ██║██║██║   █████╔╝", Colors::BRIGHT_CYAN) << "\n";
    cout << colorize("        ██║  ║██║   ██╔═██╗", Colors::BRIGHT_GREEN) << "\n";
    cout << colorize("        ██║  ║██║   ██║  ██╗", Colors::BRIGHT_YELLOW) << "\n";
    cout << colorize("        ╚═╝  ╚══╝   ╚═╝  ╚═╝", Colors::BRIGHT_WHITE) << "\n\n";
