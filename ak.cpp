...
static void showLogo() {
    // Use string_view constants for compile-time efficiency and readability.
    ...
    if (!isColorSupported()) {
        // Provide a more consistent plain-text version.
        std::cout << plain_title << "\n";
        std::cout << tagline << "\n\n";
        return;
    }

    // Chain the output for a cleaner look.
    std::cout << colorize(logo, Colors::BRIGHT_CYAN) << "\n"
