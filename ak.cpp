...
static void showLogo() {
    ...
    // Gradient from electric blue to neon cyan to bright magenta
    cout << colorize("        ████████╗   ██╗  ██╗", Colors::BRIGHT_BLUE + Colors::BOLD) << "\n";
    cout << colorize("        ██╔══╗██║   ██║ ██╔╝", Colors::BLUE + Colors::BRIGHT_CYAN) << "\n";
    cout << colorize("        ██║██║██║   █████╔╝ ", Colors::CYAN + Colors::BOLD) << "\n";
    cout << colorize("        ██║  ║██║   ██╔═██╗ ", Colors::BRIGHT_CYAN + Colors::BRIGHT_MAGENTA) << "\n";
    cout << colorize("        ██║  ║██║   ██║  ██╗", Colors::BRIGHT_MAGENTA + Colors::BOLD) << "\n";
    cout << colorize("        ╚═╝  ╚══╝   ╚═╝  ╚═╝", Colors::MAGENTA + Colors::BRIGHT_WHITE) << "\n\n";
    
    // Futuristic tagline with holographic effect
    cout << colorize("    ◦ ", Colors::BRIGHT_CYAN + Colors::BOLD) 
         << colorize("S", Colors::BRIGHT_BLUE + Colors::BOLD)
         << colorize("E", Colors::CYAN + Colors::BOLD) 
         << colorize("C", Colors::BRIGHT_CYAN + Colors::BOLD)
         << colorize("U", Colors::BRIGHT_MAGENTA + Colors::BOLD)
         << colorize("R", Colors::MAGENTA + Colors::BOLD)
         << colorize("E ", Colors::BRIGHT_WHITE + Colors::BOLD)
         << colorize("SECRET MANAGEMENT", Colors::BRIGHT_WHITE + Colors::BOLD) << "\n";
    
    cout << colorize("    ▶ ", Colors::BRIGHT_GREEN + Colors::BOLD) 
         << colorize("QUANTUM", Colors::BRIGHT_CYAN + Colors::BOLD) 
         << colorize(" • ", Colors::BRIGHT_WHITE)
         << colorize("ENCRYPTED", Colors::BRIGHT_MAGENTA + Colors::BOLD) 
         << colorize(" • ", Colors::BRIGHT_WHITE)
         << colorize("NEURAL", Colors::BRIGHT_GREEN + Colors::BOLD) << "\n";
    
    cout << colorize("    ⟡ ", Colors::BRIGHT_YELLOW + Colors::BOLD) 
         << colorize("Advanced Cryptographic Interface", Colors::BRIGHT_WHITE) << "\n\n";
    
    // Animated-style border effect
    cout << colorize("    ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━", Colors::BRIGHT_CYAN) << "\n\n";
}
